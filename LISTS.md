...
1. First, use the **`.splice(1, 1)`** method to remove the `"Old Socks"` located at index 1. *(In JS, `.splice(index, howMany)` takes the starting index and how many items you want to delete!)*
